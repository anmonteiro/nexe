...
function compile(compilerOptions, callback) {
    return __awaiter(this, void 0, void 0, function () {
        var options, compiler, nexe, error, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = options_1.normalizeOptions(compilerOptions);
                    compiler = new compiler_1.NexeCompiler(options);
                    nexe = app_builder_1.compose(clean_1.default, resource_1.default, cli_1.default, bundle_1.default, shim_1.default, options.build ? [download_1.default, artifacts_1.default].concat(patches_1.default, options.patches) : [], options.plugins);
                    error = null;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 4:
                    if (error) {
                        if (compiler.options.loglevel !== 'silent' && error) {
                            process.stderr.write(os_1.EOL + error.message + os_1.EOL);
                        }
                        compiler.quit();
                        if (callback)
