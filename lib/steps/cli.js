...
function cli(compiler, next) {
    return __awaiter(this, void 0, void 0, function () {
        var log, stdInUsed, code, _a, target, deliverable;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    log = compiler.log;
                    stdInUsed = false;
                    if (!(!process.stdin.isTTY && compiler.options.enableStdIn)) return [3 /*break*/, 3];
                    stdInUsed = true;
                    compiler.entrypoint = './__nexe_stdin.js';
                    _a = util_1.dequote;
                    return [4 /*yield*/, getStdIn(process.stdin)];
                case 1:
                    code = _a.apply(void 0, [_b.sent()]);
                    return [4 /*yield*/, compiler.addResource(path_1.resolve(compiler.options.cwd, compiler.entrypoint), code)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
                    compiler.entrypoint = './' + path_1.relative(compiler.options.cwd, compiler.options.input);
                    _b.label = 4;
                case 4:
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            deliverable
                                ...
                                if (e) {
                                    ...
                                    step.log("Entry: '" + (stdInUsed ? (compiler.options.mangle ? '[stdin]' : '[none]') : inputFile) + "' written to: " + outputFile);
